...
const { getAllTours, createTour, processTourFilters, getTourDetails, addOrRemoveFavorite, getPopularTours, getActivitiesTour, getOrganizationTours} = require('../controllers/tour/tourController')
...
router.get("/my-tours", isAuthorized, isAvailableFor('organization'), getOrganizationTours)
